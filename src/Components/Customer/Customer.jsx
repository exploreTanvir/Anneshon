      ...
      <h2 className='fw-bold pt-1 serviceTop mt-4 overflow-hidden text-center'><span className='fw-bold'>"অন্বেষণ"</span> কীভাবে কাজ করে? </h2>
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 customerRight">
            ...
            <div className="rounded-circle customerSub text-white d-flex align-items-center justify-content-center overflow-hidden"><i className="fa-solid fa-check overflow-hidden"></i></div>
              <div>
                  <h4 className='pt-1'>ইউজার টেস্টিং</h4>
            ...
            <div className="rounded-circle customerSub text-white d-flex align-items-center justify-content-center overflow-hidden"><i className="fa-solid fa-check overflow-hidden"></i></div>
              <div>
                  <h4 className='pt-1'>ডিজাইন রিভিউ</h4>
            ...
            <div className="rounded-circle customerSub text-white d-flex align-items-center justify-content-center overflow-hidden"><i className="fa-solid fa-check overflow-hidden"></i></div>
              <div>
                  <h4 className='pt-1'>স্কেলেবিলিটি</h4>
